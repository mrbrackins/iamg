    ...
    PushNotifications.getScheduledLocalNotifications(
      scheduledLocalNotifications => {
        ...
        if (!!scheduledReminderNotification) {
          PushNotifications.cancelLocalNotifications(
...
function scheduleReminderNotifications(message, reminderTime) {
  ...
  cancelReminderNotifications().then(
    scheduleRepeatingNotifications(message, date),
  );
}
